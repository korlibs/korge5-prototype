...
//
    ...
    fun testGetSync() {
        ...
        assertEquals(1, injector.get<Int>())
    }
    ...
    //    val error = assertFailsWith<RuntimeException> { injector.get<Int>() }
...
private inline fun <reified T : Any> Injector.getPath(path: String) =

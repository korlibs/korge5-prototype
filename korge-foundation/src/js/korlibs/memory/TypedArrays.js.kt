...
actual operator fun Int8Array.get(index: Int): Byte = asDynamic()[index]
actual operator fun Int16Array.get(index: Int): Short = asDynamic()[index]
actual operator fun Int32Array.get(index: Int): Int = asDynamic()[index]
actual operator fun Float32Array.get(index: Int): Float = asDynamic()[index]
actual operator fun Float64Array.get(index: Int): Double = asDynamic()[index]
actual operator fun Uint8ClampedArray.get(index: Int): Int = asDynamic()[index]
actual operator fun Uint8Array.get(index: Int): Int = asDynamic()[index]
actual operator fun Uint16Array.get(index: Int): Int = asDynamic()[index]

actual operator fun Int8Array.set(index: Int, value: Byte) { asDynamic()[index] = value }
actual operator fun Int16Array.set(index: Int, value: Short) { asDynamic()[index] = value }
actual operator fun Int32Array.set(index: Int, value: Int) { asDynamic()[index] = value }
actual operator fun Float32Array.set(index: Int, value: Float) { asDynamic()[index] = value }
actual operator fun Float64Array.set(index: Int, value: Double) { asDynamic()[index] = value }
actual operator fun Uint8ClampedArray.set(index: Int, value: Int) { asDynamic()[index] = value }
actual operator fun Uint8Array.set(index: Int, value: Int) { asDynamic()[index] = value }
actual operator fun Uint16Array.set(index: Int, value: Int) { asDynamic()[index] = value }

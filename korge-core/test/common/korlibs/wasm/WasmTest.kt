...
open class WasmTest {
    ...
    fun testSample1() = suspendTest {
        val wasmModule = createModuleRuntime("wasm/sample1.wasm", codeTrace = true)
        wasmModule.register("log", "integer") { println(it[0]) }
    ...
    fun testSample2() = suspendTest {
        val wasmModule = createModuleRuntime("wasm/sample2.wasm", codeTrace = true)
        wasmModule.register("log", "integer") { println(it[0]) }
        wasmModule.register("log", "boolean") { println(it[0]) }
    ...
    fun testMemops32() = suspendTest {
        ...
        val wasmModule = createModuleRuntime("wasm/memops32.wasm", codeTrace = true)
    ...
    fun testMalloc() = suspendTest {
        ...
        val wasmModule = createModuleRuntime("wasm/malloc.wasm", codeTrace = true)
